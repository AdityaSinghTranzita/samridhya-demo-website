        ...
        <section className="relative pt-24 pb-16 sm:pt-32 sm:pb-20 overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              {/* Subtitle */}
              <motion.p
                className="text-lg sm:text-xl text-gray-700 max-w-3xl mx-auto mb-8 sm:mb-12 leading-relaxed px-4 sm:px-0"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                ...
                <div className="bg-white rounded-3xl shadow-xl p-6 sm:p-8 lg:p-10">
                  ...
                  {isSubmitted ? (
                    ...
                    >
                      ...
                      <h3 className="text-green-800 font-bold text-lg mb-2">Message Sent Successfully!</h3>
