...
export default function FixedDepositCalculator() {
  ...
  const calculateFD = () => {
    ...
    const effectiveRate = (Math.pow(maturityAmount / principal, 1/t) - 1) * 100;

    // Calculate year-wise breakdown
    const breakdown = [];
    for (let year = 1; year <= Math.min(Math.ceil(t), 10); year++) {
      ...
      breakdown.push({
        ...
        growth: ((yearAmount - principal) / principal) * 100
      });
    }
  ...
  const downloadResults = () => {
    ...
    a.href = url;
    a.download = 'fixed-deposit-calculation.csv';
    a.click();
  ...
  return (
    <>
      <Head>
        <title>Fixed Deposit Calculator - Calculate FD Maturity Amount | Samridhya</title>
        <meta name="description" content="Calculate maturity amount and interest earned on fixed deposits. Compare different compounding frequencies and see your FD growth over time." />
        <meta name="keywords" content="fixed deposit calculator, FD calculator, maturity amount, interest calculation, bank FD" />
      </Head>
          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              <div className="inline-flex items-center gap-3 bg-white/20 backdrop-blur-sm rounded-full px-6 py-3 mb-6">
                ...
                <span className="text-white font-semibold">Fixed Deposit</span>
              </div>
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6">
                Fixed Deposit Calculator
              </h1>
              <p className="text-lg text-blue-100 max-w-3xl mx-auto">
                Calculate maturity amount and interest earned on fixed deposits. Compare different compounding frequencies and see your FD growth over time.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              >
                ...
                <button
                  onClick={calculateFD}
                  className="w-full mt-8 bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-4 rounded-xl font-semibold hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 shadow-lg hover:shadow-xl"
                >
                ...
                {results && (
                  <>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      ...
                      <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 text-center">
                        <Banknote className="w-8 h-8 text-orange-600 mx-auto mb-3" />
                        <div className="text-2xl font-bold text-gray-900">
                          ₹{principal.toFixed(0)}
                        </div>
                    ...
                    <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
                      ...
                      <div className="space-y-4">
                        <div className="flex justify-between items-center py-3 border-b border-gray-200">
                          ...
                          <span className="font-semibold text-gray-900">₹{principal.toFixed(2)}</span>
                        </div>
                        <div className="flex justify-between items-center py-3 border-b border-gray-200">
                        ...
                        <div className="flex justify-between items-center py-3">
                          ...
                          <span className="font-semibold text-blue-600">₹{results.maturityAmount.toFixed(2)}</span>
                        </div>
                      </div>
                    </div>
                  </>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-600">Check rates across different banks and NBFCs</div>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                      <div>
                        ...
                        <div className="text-sm text-gray-600">Higher compounding frequency means better returns</div>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
                      <div>
                        <div className="font-semibold text-gray-900">Tax Implications</div>
                        <div className="text-sm text-gray-600">FD interest is taxable as per your income slab</div>
                      </div>
                    </div>
                  </div>
                </div>
