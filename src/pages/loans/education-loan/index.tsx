...
import { CheckCircle2, Clock, Shield, DollarSign, Users, TrendingUp, ArrowRight, Star, Phone, Mail, MapPin, GraduationCap, BookOpen, Globe } from 'lucide-react';
...
const features = [
  {
    ...
    description: 'Comprehensive financing for international education with competitive rates',
    icon: Globe,
    gradient: 'from-blue-500 to-cyan-500'
  },
  {
    title: 'No Collateral Required',
    description: 'Unsecured education loans without any property or asset pledge',
    icon: Shield,
    gradient: 'from-green-500 to-emerald-500'
  },
  {
    title: 'Competitive Interest Rates',
    description: 'Starting from 8.50% p.a. with flexible repayment options',
    icon: TrendingUp,
    gradient: 'from-purple-500 to-pink-500'
  },
  {
    title: 'Moratorium Period',
    description: 'No EMI payments during course duration and 6 months after completion',
    icon: Clock,
    gradient: 'from-orange-500 to-red-500'
  },
  {
    title: 'Minimal Documentation',
    description: 'Simple document requirements - PAN, Aadhaar, and admission letter',
    icon: Users,
    gradient: 'from-indigo-500 to-blue-500'
  },
  {
    title: 'Flexible Repayment',
    description: 'Choose repayment tenure from 12 to 180 months as per your convenience',
    icon: CheckCircle2,
...
const loanAmounts = [
  { amount: '₹5,00,000', tenure: '12-84 months', emi: '₹8,500' },
  { amount: '₹10,00,000', tenure: '12-120 months', emi: '₹16,000' },
  { amount: '₹25,00,000', tenure: '12-180 months', emi: '₹35,000' },
  { amount: '₹50,00,000', tenure: '12-180 months', emi: '₹65,000' },
  { amount: '₹1,00,00,000', tenure: '12-180 months', emi: '₹1,20,000' }
];
...
const testimonials = [
  {
    name: 'Priya Sharma',
    role: 'MBA Student',
    content: 'Got my education loan approved quickly for my MBA abroad. The moratorium period helped me focus on studies.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'Excellent service for my engineering course. The rates were competitive and the process was hassle-free.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'Perfect solution for my medical studies. The moratorium period and flexible repayment options are great.',
    rating: 5,
...
export default function EducationLoan() {
  ...
  return (
    <>
      <Head>
        <title>Education Loan - Study Abroad & Domestic Courses | Samridhya</title>
        <meta name="description" content="Get education loans for study abroad and domestic courses from Samridhya. Up to ₹1 Crore for international studies, moratorium period, competitive rates from 8.5% p.a." />
        <meta name="keywords" content="education loan, study abroad loan, student loan, international education financing, moratorium period" />
      ...
      <section className="relative w-full bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 min-h-screen overflow-hidden pt-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32">
          <div className="text-center mb-16">
            ...
            {/* Main Heading */}
            <motion.h1
              className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold font-black text-gray-900 mb-6 leading-tight"
            ...
            >
              Education Loans
              <br />
              <span className="text-2xl sm:text-3xl md:text-4xl lg:text-3.5xl font-bold bg-gradient-to-r from-purple-500 via-blue-500 to-cyan-500 bg-clip-text text-transparent">
                For Your Future
              </span>
            </motion.h1>
            ...
            >
              Get up to ₹1 Crore for your education with moratorium period, 
              competitive rates starting from 8.50% p.a., and flexible repayment options.
            </motion.p>
      ...
      <EMICalculator 
        ...
        secondaryColor="from-purple-50 to-blue-50"
        accentColor="purple"
        id="emi-calculator"
      />
      ...
      <section className="relative py-16 sm:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-2 sm:px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Loan Amounts */}
            <motion.div
              className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-3xl p-8 shadow-lg"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
      ...
      <ExploreOtherLoans currentLoan="education-loan" />
