          ...
          <div className="text-center mb-16">
            ...
            >
              <div className="bg-white/80 backdrop-blur-sm border border-red-200 rounded-2xl p-4 text-center shadow-lg">
                <div className="text-base font-bold text-red-800 mb-1">₹25L</div>
                <div className="text-red-600 text-xs">Maximum Loan</div>
              </div>
              <div className="bg-white/80 backdrop-blur-sm border border-red-200 rounded-2xl p-4 text-center shadow-lg">
                <div className="text-base font-bold text-red-800 mb-1">12 Hrs</div>
                <div className="text-red-600 text-xs">Approval Time</div>
              </div>
              <div className="bg-white/80 backdrop-blur-sm border border-red-200 rounded-2xl p-4 text-center shadow-lg">
                <div className="text-base font-bold text-red-800 mb-1">11.50%</div>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              ...
              >
                ...
                <h3 className="text-base sm:text-lg md:text-xl lg:text-xl xl:text-2xl font-bold text-gray-900 mb-2">Emergency Support</h3>
                <p className="text-sm sm:text-base md:text-lg lg:text-lg text-gray-700">Quick access to medical funds</p>
              </motion.div>
              ...
              >
                ...
                <h3 className="text-base font-bold text-gray-900 mb-2">Fast Processing</h3>
              ...
              >
                ...
                <h3 className="text-base font-bold text-gray-900 mb-2">All Treatments</h3>
                <p className="text-xs text-gray-700">Surgery, therapy, medication & more</p>
              </motion.div>
            </div>
          </motion.div>
        </div>
