...
import { CheckCircle2, Clock, Shield, DollarSign, Users, TrendingUp, ArrowRight, Star, Phone, Mail, MapPin, Heart, Calendar, Gift } from 'lucide-react';
...
const features = [
  {
    title: 'Dream Wedding Funding',
    description: 'Comprehensive financing for your perfect wedding celebration',
    icon: Heart,
    gradient: 'from-pink-500 to-rose-500'
  },
  {
    title: 'No Collateral Required',
    description: 'Unsecured wedding loans without any property or asset pledge',
    icon: Shield,
    gradient: 'from-green-500 to-emerald-500'
  },
  {
    title: 'Competitive Interest Rates',
    description: 'Starting from 11.99% p.a. with flexible repayment options',
    icon: TrendingUp,
  ...
  },
  {
    ...
    description: 'Choose repayment tenure from 12 to 84 months as per your convenience',
    icon: CheckCircle2,
...
const loanAmounts = [
  ...
  { amount: '₹20,00,000', tenure: '12-84 months', emi: '₹52,000' }
];
...
const testimonials = [
  {
    name: 'Priya & Rahul',
    role: 'Newlyweds',
    content: 'Got our wedding loan approved in just 15 minutes! Made our dream wedding possible without any stress.',
    rating: 5,
  ...
  },
  {
    name: 'Anjali & Vikram',
    role: 'Couple',
    content: 'Excellent service and competitive rates. The EMI options were flexible and suited our budget perfectly.',
    rating: 5,
  ...
  },
  {
    name: 'Sunita & Amit',
    role: 'Married Couple',
    content: 'Quick disbursal and professional service. Highly recommended for anyone planning their wedding.',
    rating: 5,
...
export default function WeddingLoan() {
  ...
  return (
    <>
      <Head>
        <title>Wedding Loan - Dream Wedding Financing up to ₹25 Lakhs | Samridhya</title>
        <meta name="description" content="Get wedding loans up to ₹25 Lakhs from Samridhya. Finance your dream wedding with quick approval, competitive rates, and flexible repayment options." />
        <meta name="keywords" content="wedding loan, marriage loan, wedding financing, dream wedding funding, wedding expenses loan" />
      ...
      {/* Hero Section */}
      <section className="relative w-full bg-gradient-to-br from-pink-900 via-rose-900 to-red-900 min-h-screen overflow-hidden pt-20">
        {/* Animated Background Elements */}
        <div className="absolute inset-0">
          <div className="absolute top-20 left-10 w-72 h-72 bg-pink-400/20 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute top-40 right-20 w-96 h-96 bg-rose-400/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
          <div className="absolute bottom-20 left-1/4 w-80 h-80 bg-red-400/20 rounded-full blur-3xl animate-pulse delay-500"></div>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32">
          <div className="text-center mb-16">
            ...
            >
              ...
              <span className="text-white/90 font-medium">Dream Wedding Support Available</span>
            </motion.div>
            ...
            >
              Get up to ₹20 Lakhs for your dream wedding in just 10 minutes. 
              No collateral, minimal documents, and competitive rates starting from 11.99% p.a.
            </motion.p>
            ...
            >
              <motion.button
                ...
                className="group relative bg-gradient-to-r from-pink-500 to-rose-600 text-white font-bold px-8 py-4 rounded-2xl shadow-2xl hover:shadow-pink-500/25 transition-all duration-300 text-lg"
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
              >
                <span className="relative z-10">Apply Now - Get ₹5 Lakhs</span>
                <div className="absolute inset-0 bg-gradient-to-r from-pink-600 to-rose-700 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              </motion.button>
            ...
            >
              <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-4 text-center">
                <div className="text-2xl font-bold text-white mb-1">₹20L</div>
              ...
              <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-4 text-center">
                <div className="text-2xl font-bold text-white mb-1">11.99%</div>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              ...
              >
                ...
                <h3 className="text-white font-bold text-lg mb-2">Dream Wedding</h3>
                <p className="text-white/70 text-sm">Complete wedding celebration funding</p>
              </motion.div>
              ...
              >
                ...
                <h3 className="text-white font-bold text-lg mb-2">Quick Disbursal</h3>
                <p className="text-white/70 text-sm">Funds in your account within 24 hours</p>
              </motion.div>
              ...
              >
                ...
                <h3 className="text-white font-bold text-lg mb-2">All Expenses</h3>
                <p className="text-white/70 text-sm">Venue, catering, decoration & more</p>
              </motion.div>
            </div>
          </motion.div>
        </div>
      ...
      <EMICalculator 
        ...
        secondaryColor="from-pink-50 to-rose-50"
        accentColor="pink"
        id="emi-calculator"
      />

      {/* Rest of the page with background */}
      <div className="bg-gradient-to-br from-slate-50 via-pink-50 to-rose-100">
      ...
      <section className="relative py-16 sm:py-24 bg-gradient-to-br from-gray-50 to-pink-50">
        <div className="max-w-7xl mx-auto px-2 sm:px-6 md:px-12">
          <motion.div
            className="text-center mb-12 sm:mb-16"
            initial={{ opacity: 0, y: 30 }}
