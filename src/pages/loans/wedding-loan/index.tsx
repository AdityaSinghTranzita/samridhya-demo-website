...
export default function WeddingLoan() {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="relative w-full bg-gradient-to-br from-pink-50 via-rose-50 to-red-50 min-h-screen overflow-hidden pt-20">
        {/* Animated Background Elements */}
        <div className="absolute inset-0">
          <div className="absolute top-20 left-10 w-72 h-72 bg-pink-300/40 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute top-40 right-20 w-96 h-96 bg-rose-300/40 rounded-full blur-3xl animate-pulse delay-1000"></div>
          <div className="absolute bottom-20 left-1/4 w-80 h-80 bg-red-300/40 rounded-full blur-3xl animate-pulse delay-500"></div>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32">
          <div className="text-center mb-16">
            {/* Badge */}
            <motion.div
              className="inline-flex items-center gap-2 bg-pink-400/20 backdrop-blur-sm border border-pink-400/30 rounded-full px-6 py-3 mb-8"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
            >
              <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
              <span className="text-pink-700 font-medium">Dream Wedding Support Available</span>
            </motion.div>
            ...
            >
              <div className="bg-white/80 backdrop-blur-sm border border-pink-200 rounded-2xl p-4 text-center shadow-lg">
                <div className="text-base font-bold text-pink-800 mb-1">₹20L</div>
                <div className="text-pink-600 text-xs">Maximum Loan</div>
              </div>
              <div className="bg-white/80 backdrop-blur-sm border border-pink-200 rounded-2xl p-4 text-center shadow-lg">
                <div className="text-base font-bold text-pink-800 mb-1">24 Hrs</div>
                <div className="text-pink-600 text-xs">Approval Time</div>
              </div>
              <div className="bg-white/80 backdrop-blur-sm border border-pink-200 rounded-2xl p-4 text-center shadow-lg">
                <div className="text-base font-bold text-pink-800 mb-1">10.50%</div>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              ...
              >
                ...
                <h3 className="text-base sm:text-lg md:text-xl lg:text-xl xl:text-2xl font-bold text-gray-900 mb-2">Wedding Expenses</h3>
                <p className="text-sm sm:text-base md:text-lg lg:text-lg text-gray-700">Covers all wedding costs</p>
              </motion.div>
              ...
              >
                ...
                <h3 className="text-gray-900 font-bold text-base mb-2">Quick Disbursal</h3>
              ...
              >
                ...
                <h3 className="text-gray-900 font-bold text-base mb-2">All Expenses</h3>
