...
export default function PersonalLoan() {
  ...
  return (
    <>
      ...
      <section className="relative w-full bg-gradient-to-br from-blue-50 via-cyan-50 to-indigo-50 min-h-screen overflow-hidden pt-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32">
          <div className="text-center mb-16">
            ...
            >
              <div className="bg-white/90 backdrop-blur-sm border border-blue-300 rounded-2xl p-3 md:p-4 text-center shadow-lg">
                <div className="text-base md:text-lg font-bold text-blue-700 mb-1">₹40L</div>
                <div className="text-blue-500 text-xs">Maximum Loan</div>
              </div>
              <div className="bg-white/90 backdrop-blur-sm border border-blue-300 rounded-2xl p-3 md:p-4 text-center shadow-lg">
                <div className="text-base md:text-lg font-bold text-blue-700 mb-1">10 Min</div>
          ...
          >
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 max-w-4xl mx-auto">
              <motion.div
                className="bg-white/95 backdrop-blur-sm border border-blue-300 rounded-3xl p-4 md:p-6 text-center shadow-lg"
              ...
              <motion.div
                className="col-span-2 md:col-span-1 bg-white/95 backdrop-blur-sm border border-blue-300 rounded-3xl p-4 md:p-6 text-center shadow-lg"
                whileHover={{ y: -10, scale: 1.02 }}
      ...
      <ExploreOtherLoans currentLoan="personal-loan" />
