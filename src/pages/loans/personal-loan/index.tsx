          ...
          <div className="text-center mb-16">
            ...
            >
              <div className="bg-white/90 backdrop-blur-sm border border-blue-300 rounded-2xl p-4 text-center shadow-lg">
                <div className="text-lg font-bold text-blue-700 mb-1">₹40L</div>
                <div className="text-blue-500 text-xs">Maximum Loan</div>
              </div>
              <div className="bg-white/90 backdrop-blur-sm border border-blue-300 rounded-2xl p-4 text-center shadow-lg">
                <div className="text-lg font-bold text-blue-700 mb-1">10 Min</div>
                <div className="text-blue-500 text-xs">Approval Time</div>
              </div>
              <div className="bg-white/90 backdrop-blur-sm border border-blue-300 rounded-2xl p-4 text-center shadow-lg">
                <div className="text-lg font-bold text-blue-700 mb-1">10.99%</div>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              ...
              >
                ...
                <h3 className="text-base sm:text-lg md:text-xl lg:text-xl xl:text-2xl font-bold text-gray-900 mb-2">No Collateral</h3>
                <p className="text-sm sm:text-base md:text-lg lg:text-lg text-gray-700">Unsecured loans without any property pledge</p>
              </motion.div>
              ...
              >
                ...
                <h3 className="text-base font-bold text-gray-900 mb-2">Quick Disbursal</h3>
                <p className="text-xs text-gray-700">Funds in your account within 24 hours</p>
              </motion.div>
              ...
              >
                ...
                <h3 className="text-base font-bold text-gray-900 mb-2">Minimal Docs</h3>
                <p className="text-xs text-gray-700">Just PAN, Aadhaar & bank statements</p>
              </motion.div>
            </div>
          </motion.div>
        </div>
