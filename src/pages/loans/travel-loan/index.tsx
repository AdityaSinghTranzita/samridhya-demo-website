          ...
          <div className="text-center mb-16">
            ...
            >
              <div className="bg-white/80 backdrop-blur-sm border border-orange-200 rounded-2xl p-4 text-center shadow-lg">
                <div className="text-base font-bold text-cyan-800 mb-1">₹10L</div>
                <div className="text-cyan-600 text-xs">Maximum Loan</div>
              </div>
              <div className="bg-white/80 backdrop-blur-sm border border-orange-200 rounded-2xl p-4 text-center shadow-lg">
                <div className="text-base font-bold text-cyan-800 mb-1">12 Hrs</div>
                <div className="text-cyan-600 text-xs">Approval Time</div>
              </div>
              <div className="bg-white/80 backdrop-blur-sm border border-orange-200 rounded-2xl p-4 text-center shadow-lg">
                <div className="text-base font-bold text-cyan-800 mb-1">9.99%</div>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              ...
              >
                ...
                <h3 className="text-base sm:text-lg md:text-xl lg:text-xl xl:text-2xl font-bold text-gray-900 mb-2">Travel Expenses</h3>
                <p className="text-sm sm:text-base md:text-lg lg:text-lg text-gray-700">Covers all travel costs</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-xs text-gray-700">Funds in your account within 12 hours</p>
              </motion.div>
