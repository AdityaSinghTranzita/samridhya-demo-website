...
export default function TravelLoan() {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="relative w-full bg-gradient-to-br from-orange-900 via-amber-900 to-yellow-900 min-h-screen overflow-hidden pt-20">
        {/* Animated Background Elements */}
        <div className="absolute inset-0">
          <div className="absolute top-20 left-10 w-72 h-72 bg-orange-400/20 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute top-40 right-20 w-96 h-96 bg-amber-400/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
          <div className="absolute bottom-20 left-1/4 w-80 h-80 bg-yellow-400/20 rounded-full blur-3xl animate-pulse delay-500"></div>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32">
          <div className="text-center mb-16">
            ...
            >
              ...
              <span className="text-white/90 font-medium">Dream Vacation Support Available</span>
            </motion.div>
            ...
            >
              <motion.button
                ...
                className="group relative bg-gradient-to-r from-orange-500 to-amber-600 text-white font-bold px-8 py-4 rounded-2xl shadow-2xl hover:shadow-orange-500/25 transition-all duration-300 text-lg"
            ...
            >
              <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-4 text-center">
                <div className="text-2xl font-bold text-white mb-1">₹15L</div>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              ...
              >
                ...
                <h3 className="text-white font-bold text-lg mb-2">Vacation Funding</h3>
                <p className="text-white/70 text-sm">Complete travel expense financing</p>
              </motion.div>
              ...
              >
                ...
                <h3 className="text-white font-bold text-lg mb-2">All Destinations</h3>
                <p className="text-white/70 text-sm">Domestic & international travel</p>
              </motion.div>
            </div>
          </motion.div>
        </div>
