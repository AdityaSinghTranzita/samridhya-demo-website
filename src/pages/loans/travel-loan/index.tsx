        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32">
          <div className="text-center mb-16">
            ...
            >
              <motion.button
                ...
                className="group relative bg-gradient-to-r from-orange-500 to-amber-500 text-white font-bold px-8 py-4 rounded-2xl shadow-2xl hover:shadow-orange-500/25 transition-all duration-300 text-lg"
              ...
              <motion.button
                ...
                className="group relative bg-orange-400/20 backdrop-blur-sm border border-orange-400/30 text-orange-700 font-bold px-8 py-4 rounded-2xl hover:bg-orange-400/30 transition-all duration-300 text-lg"
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
              >
                Calculate EMI
            ...
            >
              <div className="bg-white/80 backdrop-blur-sm border border-orange-200 rounded-2xl p-4 text-center shadow-lg">
                <div className="text-2xl font-bold text-orange-800 mb-1">₹15L</div>
                <div className="text-orange-600 text-sm">Maximum Loan</div>
              </div>
              <div className="bg-white/80 backdrop-blur-sm border border-orange-200 rounded-2xl p-4 text-center shadow-lg">
                <div className="text-2xl font-bold text-orange-800 mb-1">10 Min</div>
                <div className="text-orange-600 text-sm">Approval Time</div>
              </div>
              <div className="bg-white/80 backdrop-blur-sm border border-orange-200 rounded-2xl p-4 text-center shadow-lg">
                <div className="text-2xl font-bold text-orange-800 mb-1">12.99%</div>
                <div className="text-orange-600 text-sm">Interest Rate</div>
              </div>
            </motion.div>
          </div>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <motion.div
                className="bg-white/80 backdrop-blur-sm border border-orange-200 rounded-3xl p-6 text-center shadow-lg"
              ...
              >
                ...
                <h3 className="text-gray-900 font-bold text-lg mb-2">Vacation Funding</h3>
                <p className="text-gray-700 text-sm">Complete travel expense financing</p>
              </motion.div>
              ...
              >
                ...
                <h3 className="text-gray-900 font-bold text-lg mb-2">All Destinations</h3>
                <p className="text-gray-700 text-sm">Domestic & international travel</p>
              </motion.div>
            </div>
          </motion.div>
        </div>
