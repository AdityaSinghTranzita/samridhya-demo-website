...
export default function CacheTest() {
  ...
  const [localStorageData, setLocalStorageData] = useLocalStorage<CacheTestData>('cache-test-data', {
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-gray-800 mb-8">Cache Prevention Test</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="space-y-2">
                <p><strong>Test Value:</strong> {localStorageData.testValue}</p>
                <p><strong>Timestamp:</strong> {new Date(localStorageData.timestamp).toLocaleString()}</p>
                <p><strong>Last Visit:</strong> {localStorageData.lastVisit ? new Date(localStorageData.lastVisit).toLocaleString() : 'Never'}</p>
              </div>
              <p className="text-sm text-gray-600 mt-2">
          ...
          <div className="mt-8 bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button
                onClick={() => typeof window !== 'undefined' && (window.location.href = '/cache-test')}
