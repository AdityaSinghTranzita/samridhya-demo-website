  ...
  return (
    <Html lang="en">
      <Head>
        ...
        {/* ==========================================
           FACEBOOK META PIXEL CODE - TRACKING ID: 1421958515748064
           ========================================== */}
        <script
          dangerouslySetInnerHTML={{
            __html: `
        ...
        <noscript>
          <img 
            ...
            width="1" 
            style={{display: 'none'}}
            src="https://www.facebook.com/tr?id=1421958515748064&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
        {/* ==========================================
