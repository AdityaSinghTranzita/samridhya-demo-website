          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
              ...
              >
                ...
                <p className="text-gray-600 text-sm">100% secure & regulated</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600 text-sm">You own your data</p>
              </motion.div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="bg-white rounded-3xl shadow-xl p-8 sm:p-12 space-y-8">
              ...
              {/* Section 4 */}
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">4. We Collect Cookies</h2>
              ...
              {/* Section 5 */}
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">5. How do We Use The Information</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              {/* Section 6 */}
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">6. Disclosure to Third Parties</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              {/* Section 7 */}
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">7. Data Storage</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              {/* Section 8 */}
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">8. What Is Your Control Over Your Personal Information That's Collected And Used Online</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              {/* Section 9 */}
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">9. Revocation of Consent and Deletion of Data</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              {/* Section 10 */}
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">10. Log Files</h2>
                <p className="text-gray-700 leading-relaxed">
              ...
              {/* Section 12 */}
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">12. Third-Party Advertisers and Links to Other Applications</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              {/* Section 13 */}
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">13. Changes in this Privacy Policy</h2>
                <p className="text-gray-700 leading-relaxed">
              ...
              {/* Section 14 */}
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">14. Lending partners for personal loans</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              {/* Section 15 */}
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">15. Non Predatory Loans policy</h2>
              ...
              {/* Section 16 */}
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">16. Nodal Grievance Officer</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg p-6 space-y-3 border border-blue-100">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 text-sm">(Lines are open Mon-Sat from 9:30am to 6:30pm)</p>
                    </div>
                  </div>
                </div>
              </section>
              ...
              {/* Section 17 */}
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">17. Data Grievance Officer</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
