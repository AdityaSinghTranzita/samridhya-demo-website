...
export default function WhyChoose() {
    return (
        <section className="relative bg-gradient-to-br from-[#f8f8f8] via-slate-50 to-white py-20 px-4 md:px-12 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                >
                    <motion.div
                        className="inline-flex items-center gap-2 bg-gradient-to-r from-[#276ef4]/10 to-green-500/10 text-[#276ef4] px-6 py-3 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm border border-[#276ef4]/20 shadow-lg"
                    ...
                    >
                        ...
                        <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
                            ...
                            <span className="bg-gradient-to-r from-green-500 to-emerald-500 bg-clip-text text-transparent font-bold text-2xl">
                                9.99% p.a.
                            </span>
                        </p>
                    </motion.div>

                    <div className="w-24 h-1 bg-gradient-to-r from-[#276ef4] to-green-500 rounded-full mx-auto mt-8"></div>
                </motion.div>
                            ...
                            >
                                ...
                                <div className="relative z-10 flex items-start space-x-5">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p className="text-gray-700 group-hover:text-gray-800 transition-colors duration-300 text-base md:text-lg leading-relaxed font-medium">
                                            {feature.text}
                                        </p>
                ...
                >
                    <div className="bg-gradient-to-r from-[#276ef4] to-green-500 rounded-3xl p-8 md:p-12 text-white shadow-2xl">
