...
export default function Carousel() {
  ...
  return (
      <section
          className="relative w-full h-screen overflow-hidden pt-16 md:pt-20 bg-gradient-to-br from-cyan-100 via-blue-200 to-dar-300"
          {...swipeHandlers}
      >

      {/* Animated gradient overlay for depth */}
        <div className="absolute inset-0 bg-gradient-to-r from-blue-400/10 via-transparent to-indigo-400/10 animate-pulse"></div>
        ...
        <AnimatePresence initial={false} mode="wait">
          ...
          >
            ...
            <div className="w-full md:w-1/2 text-center md:text-left space-y-5 z-10">
              ...
              <motion.button
                  className="bg-[#276ef4] text-white px-6 py-3 rounded-full font-medium hover:bg-blue-200 hover:text-black transition shadow-lg hover:shadow-xl"
                  initial={{ scale: 0.95, opacity: 0 }}
                  animate={{ scale: 1, opacity: 1 }}
