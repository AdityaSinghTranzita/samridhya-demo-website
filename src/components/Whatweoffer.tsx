...
import {
  ...
  ChevronDown,
  ChevronUp,
  Landmark, // Icon for Gold (asset/security)
  ShieldCheck // Icon for CGTMSE (guarantee/protection)
} from 'lucide-react';
...
const offers = [
  ...
  },
  {
    ...
    description: 'Credit Guarantee Scheme for collateral-free business loans up to ₹5 Crore.',
    href: 'https://apply.samridhya.com/cgtmse',
    icon: ShieldCheck,
    gradient: 'from-yellow-600 to-orange-500', // Unique gradient to highlight a special scheme
    bgGradient: 'from-yellow-50 to-orange-50',
    amount: '₹5 Cr',
    time: 'Guarantee',
    features: ['Collateral-free loans', 'Higher loan amount', 'New/Existing MSEs']
  },
  // -------------------------
  {
  ...
  {
    title: 'Gold Loan',
    description: 'Unlock the value of your gold instantly with minimal paperwork.',
    ...
    amount: 'High LTV',
    time: 'Quick Process',
    features: ['Low interest rates', 'Flexible tenure', 'Safe gold storage']
  }
  // -------------------------
];
                      ...
                      <div className="flex items-start justify-between mb-4 sm:mb-6">
                        ...
                        <div className="text-right">
                          ...
                          <div className="text-xs sm:text-sm text-gray-500 font-medium">
                            {/* Display "up to" only for time-based items */}
                            {offer.time.includes('min') || offer.time.includes('years') || offer.time.includes('hours') ? 'up to ' : ''}
                            {offer.time}
                          </div>
                        </div>
                      </div>
